...
RUN apt update
RUN DEBIAN_FRONTEND=noninteractive apt install python3-dev python3-pip wine qemu-kvm *zenhei* xz-utils dbus-x11 curl firefox-esr gnome-system-monitor mate-system-monitor  git xfce4 xfce4-terminal tightvncserver wget   -y
